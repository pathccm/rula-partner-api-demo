...
export const FAITH_MAP: Record<string, string> = {
  Agnostic: 'agnostic',
  Atheist: 'atheist',
  Buddhist: 'buddhist',
  Christian: 'christian',
  ...
  "Jehovah's Witness": 'jehovahs_witness',
  Jewish: 'jewish',
  Mormon: 'mormon',
  Muslim: 'muslim',
...
export const ALLYSHIP_MAP: Record<string, string> = {
  'Aviation Professionals': 'aviation',
  BIPOC: 'bipoc',
  Blind: 'blind',
  'Body Positivity': 'body_positivity',
  Cancer: 'cancer',
  Deaf: 'deaf',
  Educators: 'educators',
  'First Gen American/Immigrant Parents': 'first_generation',
  'Police/Fire/First Responders': 'first_responder',
  Gay: 'gay',
  'HIV/AIDS': 'hiv_aids',
  'Immune-Disorders': 'immune_disorders',
  Intersex: 'intersex',
  Lesbian: 'lesbian',
  'LGBTQIA+': 'lgbtqia',
  'Little Person': 'little_person',
  'Military/Veterans': 'military',
  'Non-Binary': 'non_binary',
  'Open Relationships/Non-Monogamy': 'non_monogamy',
  Queer: 'queer',
  'Racial Justice': 'racial_justice',
  'Recovery/12 Step Friendly': 'recovery',
  'Sex-Positive/Kink': 'sex_positive',
  'Sex Worker': 'sex_worker',
